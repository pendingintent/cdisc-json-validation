...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="YAML/JSON utilities: convert YAML to JSON or validate JSON against a schema.")
    subparsers = parser.add_subparsers(dest="command", required=True)

    # Subparser for conversion
    convert_parser = subparsers.add_parser("convert", help="Convert a YAML file to JSON format.")
    ...
    validate_parser = subparsers.add_parser("validate", help="Validate a JSON file against a USDM schema (v4 default).")
